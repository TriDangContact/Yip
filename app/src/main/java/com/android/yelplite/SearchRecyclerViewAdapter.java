...
import com.android.yelplite.SearchListFragment.OnSearchListFragmentInteractionListener;
import com.android.yelplite.dummy.DummyContent.DummyItem;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link DummyItem} and makes a call to the
 * specified {@link com.android.yelplite.SearchListFragment.OnSearchListFragmentInteractionListener}.
...
public class SearchRecyclerViewAdapter extends RecyclerView.Adapter<SearchRecyclerViewAdapter.ViewHolder> {
    ...
    public SearchRecyclerViewAdapter(List<DummyItem> items,
